...
export function Home() {
  ...
  const featuredCategories = [
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1568115286680-d203e08a8be6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
      count: '40+ Designs',
    },
    {
      id: '3',
      title: 'Elegant Beds',
      image:
        'https://images.unsplash.com/photo-1762803733564-fecc7669a91a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080',
      count: '35+ Designs',
    },
    {
      id: '4',
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        'Absolutely stunning pieces! The quality and craftsmanship exceeded my expectations. Perfect for my luxury projects.',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'The interior design service transformed our living space into something extraordinary. Highly recommend!',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'We furnish all our luxury properties with Luxora. The premium quality and elegant designs are unmatched.',
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          ...
          >
            ...
            <p className="mb-8 opacity-90" style={{ fontSize: '1.1rem' }}>
              Discover our curated collection of premium furniture and bespoke interior design
              services that transform spaces into masterpieces.
            </p>
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-primary-foreground">
            ...
            >
              ...
              <p className="mb-8 opacity-90" style={{ fontSize: '1.1rem' }}>
                Our expert interior designers work with you to create luxurious, functional spaces
